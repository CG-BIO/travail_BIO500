...
\begin{frontmatter}
  ...
  \title{Short Paper}
    \author[Universite\_minuscule de Sherbrooke]{Nicolas Beaudoin%
  \corref{cor1}%
  \fnref{1}}
   \ead{bean1710@usherbrooke.ca} 
    \author[Universite\_minuscule de Sherbrooke]{Camille Gagnon%
  %
  }
   \ead{gagc3901@usherbrooke.ca} 
    \author[Universite\_minuscule de Sherbrooke]{Marilou Cournoyer%
  %
  \fnref{2}}
   \ead{coum3903@userhbrooke.ca} 
    \author[Universite\_minuscule de Sherbrooke]{Francis Boily%
  %
  \fnref{2}}
   \ead{boif2411@usherbrooke.ca} 
      \affiliation[Département des sciences]{Department, Street, City,
State, Zip}
...
Zip}
  ...
  \begin{abstract}
  This is the abstract.Question d'analyse et de rechercheNous voulons
  regarder l'immigration et l'émigration ainsi que la dispersion au sein
  des différentes communautés de la classe. Analyse basée sur les
  spécialistes et généralistes OU introverties et extraverties ? On
  pourrait aussi comparer l'immigration comme étant un indicateur
  d'adaptation et de survie au niveau psychologique chez l'être humain.
  Exemple, l'être humain ne se reconnait pas ou vit un stress dans ses
  relations sociales (peu de compatibilité) alors il va migrer ailleurs.
