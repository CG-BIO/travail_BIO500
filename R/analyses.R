fct_analyse <- function (nettoyage) {
  ...
  ## FAIRE LES REQUETES SQL DEMANDEES
...
## POST-TRAITEMENT SUR R


# Enregistrer les requetes SQL sous format .csv
...
liste_analyses <- list(nb_liens_paires, moyenne_liens_annee)
return(liste_analyses)
}
